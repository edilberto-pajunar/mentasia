        ...
        return Column(
          children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: widget.messages[index]['isUserMessage'] ? tPrimaryColor : tBlackColor.withOpacity(0.3),
                  ),
                  constraints: BoxConstraints(maxWidth: width * 2 / 3),
                  child: Text(
                    widget.messages[index]['message'],
                    style: TextStyle(
                      color: widget.messages[index]['isUserMessage'] ? tWhiteColor : tWhiteColor,
                    ),
                  ),
                ),
              ],
            ...
            _DateLabel(
              ...
              alignment: widget.messages[index]['isUserMessage'] ? Alignment.bottomRight : Alignment.bottomLeft,
            ),
          ],
        );
      },
